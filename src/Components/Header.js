  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/">
          <p
            className="text-2xl bg-clip-text bg-gradient text-transparent md:text-xl xl:text-2xl xl:leading-tight font-bold"
          >
            Sağyn
          </p>
        </NavLink>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          ...
          <li className="pb-1 md:pb-0">
            <NavLink to="/honors" onClick={toggleClass}>
              Honors
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li>
            <a href={instagram} target="_blank" rel="noreferrer noopener">
              <svg className="dark:fill-light-heading fill-light-heading" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
